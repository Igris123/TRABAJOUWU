...
@php
$inputs = [
    ['type' => 'text', 'name' => 'fullname', 'label' => 'Nombre Completo'],
    ['type' => 'email', 'name' => 'email', 'label' => 'Dirección de correo'],
    ['type' => 'tel', 'name' => 'phone_number', 'label' => 'Numero de telefono']
];
@endphp
    ...
    <div class="px-2 container mx-auto max-w-7xl flex flex-wrap justify-center my-16">
        <div class="dark:bg-gray-800 w-full sm:w-500 px-8 py-4 border border-gray rounded-sm">
            ...
            <form action="{{ route('order.create') }}" method="post">
                ...
                >
                @endforeach
                <label class="text-xs text-gray-500 dark:text-gray-300">Dirección entrega</label>
