    ...
    <div class="px-2 container mx-auto max-w-7xl flex flex-wrap justify-center my-10">
        <div class="border bg-white dark:bg-gray-800 border-gray mx-auto w-full sm:w-400 px-8 py-4 rounded-sm my-20">
            <form action="{{ route('order.request-my-orders') }}" method="post">
                <h1 class="my-2 font-bold text-sm text-current-600 dark:text-current-400">Le enviaremos un enlace donde puede ver todos sus pedidos.</h1>
                ...
                <label class="text-xs text-gray-600 dark:text-gray-300">Ingrese el correo electrónico con el que realizó sus pedidos.</label>
                <input
