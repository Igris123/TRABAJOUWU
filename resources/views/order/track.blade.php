...
@section('content')
    @include('layouts.navbar')
        <h1 class="text-center font-bold text-gray-600 dark:text-gray-200 text-xl sm:text-2xl my-8">Seguimiento Pedidos</h1>
