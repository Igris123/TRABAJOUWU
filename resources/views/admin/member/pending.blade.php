            ...
            <div class="bg-white dark:bg-gray-800 border border-gray relative space-y-2">
                ...
                <div class="flex space-x-4">
                    <div class="flex-1 space-y-1 px-2">
                        ...
                        <div class="self-center w-40 text-gray-600 dark:text-gray-200 text-xs truncate"><strong>Nombre completo:</strong> {{ $member->fullname }}</div>
                        <div class="self-center w-40 text-gray-600 dark:text-gray-200 text-xs truncate"><strong>Email:</strong> {{ $member->email }}</div>
                        <div class="self-center w-40 text-gray-600 dark:text-gray-200 text-xs truncate"><strong>>Numero de telefono:</strong> {{ $member->phone_number }}</div>
