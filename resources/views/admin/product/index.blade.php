                ...
                <div class="p-2">
                    <div class="space-y-4 mt-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="w-200 break-words truncate flex space-x-1">
                                <p class="font-bold text-gray-600 dark:text-gray-400 text-xs">Nombre envio:</p>
                                <p class="text-xs text-gray-600 dark:text-gray-200 truncate">{{ $product->name }}</p>
                            </div>
                            <div class="w-200 break-words truncate flex space-x-1">
                                <p class="font-bold text-gray-600 dark:text-gray-400 text-xs">Contador:</p>
                                <p class="text-xs text-gray-600 dark:text-gray-200 truncate">{{ $product->orders_count }}</p>
                            </div>
                            <div class="w-200 break-words truncate flex space-x-1">
                                <p class="font-bold text-gray-600 dark:text-gray-400 text-xs">Precio envio:</p>
