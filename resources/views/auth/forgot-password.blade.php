    ...
    <div class="px-2 container mx-auto max-w-7xl flex flex-wrap justify-center my-20">
        <div class="border bg-white border-gray mx-auto w-full sm:w-400 px-8 py-4 rounded-sm my-20">
            <form action="{{ route('password.email') }}" method="post">
                <h1 class="my-2 font-bold text-sm text-current-600 dark:text-current-400">Le enviaremos un enlace de restablecimiento de contraseña.</h1>
                ...
                <label class="text-xs text-gray-500 dark:text-gray-300">Por favor ingrese el correo electrónico asociado a su cuenta.</label>
                <input
